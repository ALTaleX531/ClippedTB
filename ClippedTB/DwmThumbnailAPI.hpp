	...
	namespace DwmThumbnailAPI
	{
		...
		static const auto g_actualDwmpQueryThumbnailType
		{
			reinterpret_cast<HRESULT(WINAPI*)(IN HTHUMBNAIL, OUT THUMBNAIL_TYPE*)>(
				GetProcAddress(wil::unique_hmodule{LoadLibraryW(L"dwmapi.dll")}.get(), MAKEINTRESOURCEA(114))
			)
		};
		static const auto g_actualDwmpCreateSharedThumbnailVisual
		{
			...
			> (
				GetProcAddress(wil::unique_hmodule{LoadLibraryW(L"dwmapi.dll")}.get(), MAKEINTRESOURCEA(147))
			)
		};
		static const auto g_actualDwmpQueryWindowThumbnailSourceSize
		{
			...
			> (
				GetProcAddress(wil::unique_hmodule{LoadLibraryW(L"dwmapi.dll")}.get(), MAKEINTRESOURCEA(162))
			)
		};
		...
		static const auto g_actualDwmpCreateSharedVirtualDesktopVisual
		{
			...
			> (
				GetProcAddress(wil::unique_hmodule{LoadLibraryW(L"dwmapi.dll")}.get(), MAKEINTRESOURCEA(163))
			)
		};
		static const auto g_actualDwmpUpdateSharedVirtualDesktopVisual
		{
			...
			> (
				GetProcAddress(wil::unique_hmodule{LoadLibraryW(L"dwmapi.dll")}.get(), MAKEINTRESOURCEA(164))
			)
		};
